...
class SumTrainer(object):
    ...
    def train(self, model):
        ...
        if self.opts.bert_optim:
            ...
            scheduler = get_linear_schedule_with_warmup(optimizer, num_warmup_steps=train_iter*0.02,
                                                        num_training_steps=train_iter)
        ...
        for epoch in range(self.opts.epochs):
            ...
            for i, data in enumerate(self.train_data_loader):
                ...
                sys.stdout.flush()
                glob_steps += 1
                if glob_steps*self.opts.batch_size % 60000 == 0:
                    logger.info("[INFO] Per 60000 Eval val dataets!")
